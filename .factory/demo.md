...
After the first visit, the service worker caches the `/demo/` shell for the offline claim. Speech still depends on a voice installed by the browser or operating system.
